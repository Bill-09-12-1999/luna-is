...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <link rel="stylesheet" href="../css/official_s.css">
  ...
  color:white;
  text-align:center;
  background-image: linear-gradient(to right ,transparent,#333333,#333333,#333333, black);
...
<nav class="navbar navbar-inverse" style="border-radius:0px;">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="official_s.php"><img alt="Brand" src="../assets/logo.png" style="width:50px; margin-top:-15px; "></a>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="officials.php">light Mode</a></li>
