                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="txt_hof" name="txt_hof" class="form-control input-sm select2"  type="text" style="width:100%" onchange="show_total()">
                                ...
                                <div class="form-group">
                                    ...
                                    <input  id="txt_totalmembers"  name="txt_totalmembers" class="form-control input-sm" type="number" placeholder="Total Number of Members"/>
                                </div>
                            </div>
                        </div>
