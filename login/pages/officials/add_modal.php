                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="txt_sterm" type="date" name="txt_sterm" class="form-control input-sm" type="date" placeholder="Start Term"/>
                                </div>
                                <div class="form-group">
                                    <label>End Term:</label>
                                    <input name="txt_eterm" type="date"class="form-control input-sm" type="date" placeholder="End Term"/>
                                </div>
                            </div>
                        </div>
