                            ...
                            <div class="box">
                                ...
                                <form method="post">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT *,CONCAT(r.lname, ', ' ,r.fname, ' ' ,r.mname) as residentname,p.residentid as pid FROM tblpermit p left join tblresident r on r.id = p.residentid where status = 'New'") or die('Error: ' . mysqli_error($con));
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
