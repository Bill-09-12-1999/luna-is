...
<script>
	Morris.Donut({
		...
		data: [{
			...
			value: <?php 
					$q = mysqli_query($con,"SELECT * from tblresident where highestEducationalAttainment = 'Bachelors degree'");
					$numrow = mysqli_num_rows($q);
					echo $numrow;
			 	?>
		}, {
			...
			value: <?php 
					$q = mysqli_query($con,"SELECT * from tblresident where highestEducationalAttainment = 'Masters degree' ");
					$numrow = mysqli_num_rows($q);
					echo $numrow;
			 	?>
		}, {
