<?php
                            ...
                            $SQL2 = "SELECT count(*) as NumberofResident,Zone FROM tblresident r group by r.zone DESC";
                            $SQL3 = "SELECT COUNT( * ) as NumberofResident , Age FROM tblresident GROUP BY age DESC";
                            $SQL4 = "SELECT count(*) as NumberofResident,HighestEducationalAttainment from tblresident group by highesteducationalattainment DESC";
