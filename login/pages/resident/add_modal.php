              ...
              <div class="modal-dialog modal-lg" >
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Register Residents</h4>
                    </div>
                            ...
                            <div class="container-fluid">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_mstatus" class="form-control input-sm input-size" type="text" placeholder="Region"/>
                                    </div> 

                                     <div class="form-group">
                                        <label class="control-label">Province:</label>
                                        <input name="txt_igpit" class="form-control input-sm input-size" type="text" placeholder="Province" />
                                    </div>


                                     <div class="form-group">
                                        <label class="control-label">Number:</label></label><br>
                                        <input name="txt_length" class="form-control input-sm input-size" type="number"  placeholder="Number"required/>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="ddl_los" class="form-control input-sm" type="text" placeholder="Qualifier" required/>
                                        </div>
                                        <div class="col-sm-4">
                                        ...
                                        <div class="col-sm-4">
                                             <select name="ddl_voter" class="form-control input-sm ">
                                            <option selected="" disabled="" ><b>Voter</b></option>
                                    ...
                                    <!--    </div>-->
                                    <!--    <div class="col-sm-4">-->
                                    <!--      <label class="control-label" style="position:absolute; top:-27px;">Gender:</label>&nbsp;-->
                                    <!--    </div>-->
                                    <!--    <div class="col-sm-4">     -->
                                        <!--<label class="control-label">Gender:</label>-->
                                    <!--    <select name="ddl_gender" class="form-control input-sm " style="position:absolute; left:-135px;">-->
                                    <!--        <option selected="" disabled="">Gender</option>-->
                                    <!--        <option value="Male">Male</option>-->
                                    <!--        <option value="Female">Female</option>-->
                                    <!--    </select>-->
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input name="txt_dperson" class="form-control input-sm" type="text" placeholder="City/ Municipality"/>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="control-label">Barangay:</label>
                                        <input name="txt_brgy" class="form-control input-sm" type="text" placeholder="Barangay"required/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="txt_income" class="form-control input-sm" type="number" min="0" placeholder="Monthly Income"/>
                                    </div>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input name="txt_upass" class="form-control input-sm input-size" type="password" placeholder="Password"required/>
                                    </div>
