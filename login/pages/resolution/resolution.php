                                ...
                                <div class="box-header">
                                    <div style="padding:10px;">
                                        ...
                                        ?>
                                                ...
                                                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"><i class="fa fa-user-plus" aria-hidden="true"></i>Add Resolution</button>
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            if($_SESSION['role'] == "Administrator")
                                            {
                                                ...
                                                $squery = mysqli_query($con, "select * from tblresolution order by resno ASC");
                                                while($row = mysqli_fetch_array($squery))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button class="btn btn-primary btn-sm" data-target="#viewModal'.$row['id'].'" data-toggle="modal"><i class="fa fa-search" aria-hidden="true"></i> File</button>
                                                        </td>
                                                    </tr>
                                                    ';
