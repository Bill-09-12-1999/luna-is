	...
	<aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    if($_SESSION['role'] == "Administrator"){
                        echo '
                    <ul class="sidebar-menu" style="transition:1s ease;">
                    <li>
                                <a href="../../main/officials.php">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="../update-image/index.php">
                                    <i class="fa fa-user"></i> <span>Barangay Official Images</span>
                                </a>
                            </li>
                             <li>
                             ...
                             <li>
                                <a href="../resolution/resolution.php">
                                    <i class="fa fa-file"></i> <span>Resolution</span>
                                </a>
                            </li>
                            <li>
                                <a href="../ordinance/ordinance.php">
                                    <i class="fa fa-file"></i> <span>Ordinance</span>
                                </a>
                            </li>
                            <li>
